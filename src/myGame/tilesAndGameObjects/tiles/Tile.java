package myGame.tilesAndGameObjects.tiles;
...
public class Tile {
	...
	public static Tile createFromID(int itemId) throws IOException {
		...
		switch (itemId) {
	        ...
	        case 19:{
	        	tile.setImage(ImageIO.read(
    			Tile.class.getResourceAsStream("/resources/images/tiles/rightTopCorner.png")));
	        	tile.setCrossable(true); // road tile is crossable
	        	return tile;
	        }
	        case 20:{
	        	tile.setImage(ImageIO.read(
    			Tile.class.getResourceAsStream("/resources/images/tiles/rightDownCorner.png")));
	        	tile.setCrossable(true); // road tile is crossable
	        	return tile;
	        }
	        case 21:{
	        	tile.setImage(ImageIO.read(
    			Tile.class.getResourceAsStream("/resources/images/tiles/leftTopCorner.png")));
	        	tile.setCrossable(true); // road tile is crossable
	        	return tile;
	        }
	        case 22:{
	        	tile.setImage(ImageIO.read(
    			Tile.class.getResourceAsStream("/resources/images/tiles/leftDownCorner.png")));
	        	tile.setCrossable(true); // road tile is crossable
	        	return tile;
	        }
